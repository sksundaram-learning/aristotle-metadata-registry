...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'aristotle_mdr_valuedomain', 'format', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PermissibleValue.meaning'
        db.alter_column(u'aristotle_mdr_permissiblevalue', 'meaning', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PermissibleValue.value'
        db.alter_column(u'aristotle_mdr_permissiblevalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'SupplementaryValue.meaning'
        db.alter_column(u'aristotle_mdr_supplementaryvalue', 'meaning', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PermissibleValue.meaning'
        db.alter_column(u'aristotle_mdr_permissiblevalue', 'meaning', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PermissibleValue.value'
        db.alter_column(u'aristotle_mdr_permissiblevalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SupplementaryValue.meaning'
        db.alter_column(u'aristotle_mdr_supplementaryvalue', 'meaning', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SupplementaryValue.value'
        db.alter_column(u'aristotle_mdr_supplementaryvalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=20))
